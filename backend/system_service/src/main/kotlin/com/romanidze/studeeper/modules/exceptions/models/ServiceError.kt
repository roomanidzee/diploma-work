package com.romanidze.studeeper.modules.exceptions.models
...
public class ServiceError() {
    ...
    private fun addValidationError(fieldError: FieldError) = 
            this.addValidationError(
                ...
                fieldError.field,
                fieldError.rejectedValue as JvmType.Object,
                fieldError.defaultMessage!!
            )

    public fun addValidationFieldErrors(fieldErrors: List<FieldError>) = 
